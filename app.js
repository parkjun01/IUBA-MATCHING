...
function selectManualSizeConfig(twos, threes) {
  const { fixedTeams, remaining, activeVenues } = _comboPicker;
  ...
  const venuesForAuto = activeVenues.filter(v => !usedVenueIds.has(v.id));
...
function finalizeManual() {
  ...
  _comboPicker = { fixedTeams, remaining, activeVenues };
